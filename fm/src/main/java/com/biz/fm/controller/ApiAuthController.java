...
private final ApiAuthService apiAuthService;
    ...
    public ResponseEntity<?> tokenIssue(
    		@ApiParam(value = "앱 키", required = true) @RequestParam String appKey, ServletRequest request) throws NotFoundException, ParseException {
    ...
    public ResponseEntity<?> tokenReissue(
    		@ApiParam(value = "토큰 재발급 정보", required = true) @RequestBody NewAccessToken1 newAccessToken, HttpServletRequest request) 
