...
public class MenuController {
	...
	@ApiOperation(value = "메뉴 이미지 수정", notes = "메뉴 이미지를 수정한다.")
	public ResponseEntity<Boolean> updateImage(@ApiParam(value = "메뉴 id", required = true) @PathVariable String menuId,
									 		 @ApiParam(value = "메뉴 수정 정보", required = true) @RequestBody MenuImageUpdate imageUpdate){
		return ResponseEntity.ok(menuService.updateMenuImage(menuId, imageUpdate));
	}
